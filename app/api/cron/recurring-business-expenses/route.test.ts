...
// supabase/tests/recurring_business_expenses.test.sql against the real
// database function this route calls — this file only covers what's
// specific to the HTTP layer: who is allowed to trigger it. Mirrors
// app/api/cron/recurring-billing/route.test.ts exactly.

import { test } from "node:test";
import assert from "node:assert/strict";
import { GET } from "./route.ts";

const CRON_URL = "http://localhost/api/cron/recurring-business-expenses";
...
// promise (see the sibling recurring-billing route.test.ts for the
// same established pattern and the bug this specifically guards against).
